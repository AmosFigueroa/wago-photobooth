...
const Editor = () => {
  ...
  const createPattern = (ctx, type, color) => {
    ...
    // Background dasar transparan/putih
    tCtx.fillStyle = "#ffffff";
    tCtx.fillRect(0, 0, size, size);

    // Warna Pola dari Input
  ...
  useEffect(() => {
    ...
    // LOGIKA RENDER BACKGROUND (FIXED LOGIC)
    if (bgType === "color") {
      ...
      bgImg.onerror = () => {
        console.warn("Gagal load BG image, fallback ke putih");
  ...
  const handleFinish = () => {
    if (canvasRef.current) {
      try {
        ...
        alert("Gagal simpan gambar. Coba ganti background.");
      }
    }
  };
                  ...
                  <div className="relative aspect-square rounded-full border-2 overflow-hidden bg-gradient-to-tr from-pink-200 to-blue-200 cursor-pointer group">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setBgType("color"); // FORCE MODE COLOR
                      }}
                    ...
                    {customAssets.bgs.map((bg) => (
                      <button
                        ...
                        onClick={() => {
                          ...
                          setBgType("image"); // FORCE MODE IMAGE
                        }}
                  ...
                  <div className="w-8 h-8 rounded-full border overflow-hidden relative bg-white shadow-sm cursor-pointer">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        // OTOMATIS GANTI KE PATTERN MODE JIKA WARNA DIGANTI
                  ...
                  {patterns.map((p) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        setBgType("pattern"); // FORCE MODE PATTERN
                      }}
